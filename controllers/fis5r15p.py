...
def fis_opt(e_theta, error, params, grafica=False):
    ...
    if grafica:
        ...
        ax0.plot(x_e_theta, e_theta_hi_neg, 'b', linewidth=1.5, label='High Negative')
        ax0.plot(x_e_theta, e_theta_med_neg, 'm', linewidth=1.5, label='Medium Negative')
        ax0.plot(x_e_theta, e_theta_lo, 'g', linewidth=1.5, label='Low')
